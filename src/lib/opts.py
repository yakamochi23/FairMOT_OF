...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--val_visdrone_pedi', default=False, help='val visdrone_pedi')
    self.parser.add_argument('--test_visdrone_pedi', default=False, help='test visdrone_pedi')
    self.parser.add_argument('--val_visdrone_car', default=False, help='val visdrone_car')
    self.parser.add_argument('--test_visdrone_car', default=False, help='test visdrone_car')
    self.parser.add_argument('--train_uavdt_car', default=False, help='train uavdt_car')
    self.parser.add_argument('--test_uavdt_car', default=False, help='test uavdt_car')
    self.parser.add_argument('--custom', default=False, help='custom dataset')
    ...
    self.parser.add_argument('--data_dir', type=str, default='D:/Dataset/')
