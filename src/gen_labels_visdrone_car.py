    ...
    for seq in tqdm(seq_names):
        ...
        with open(seq_txt_f_path, 'r') as srcfile, open(dst_gt_txt_path, 'w') as dstfile:
            for line in srcfile:
                ...
                if len(columns) >= 7 and columns[7] == '4':
                    dstfile.write(line)
        # --------------------------------------------------------------------------------------------------------        
...
if __name__ == '__main__':
    ...
    #    dst_root='D:/Dataset/VisDrone_car/images/train',
    #    viz_root='D:/Dataset/VisDrone_car/viz/train'
    #)

    #gen_track_dataset(
    #    src_root='D:/Dataset/VisDrone2019_mot/val',
    #    dst_root='D:/Dataset/VisDrone_car/images/val',
    #    viz_root='D:/Dataset/VisDrone_car/viz/val'
    #)

    #gen_track_dataset(
    #    src_root='D:/Dataset/VisDrone2019_mot/test',
    #    dst_root='D:/Dataset/VisDrone_car/images/test',
    #    viz_root='D:/Dataset/VisDrone_car/viz/test'
    #)

    # trainタスクの.trainvalファイルを生成
    gen_dot_train_file(
        data_root = 'D:/Dataset/', # データセットのルートディレクトリ
        rel_path='VisDrone_car/images/trainval', # 相対パス
        out_root='C:/Users/Image--lab/Desktop/FairMOT/src/data', # 出力先ディレクトリ
        f_name='visdrone_car.trainval' # 出力ファイル名
    )